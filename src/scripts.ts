...
insertedString('1234567','.'); // '1.234.567'
insertedString('abcde','$'); // 'ab$cde'
insertedString('zxyzxyzxyzxyzxyz','w'); // 'zwxyzwxyzwxyzwxyzwxyz'
...
const combinedArray = (...arrays: any[]): any[] => {
    let combined: any[] = [];
...
const sortedObjArray = (objArr: {a: number, b: number}[]): {a: number, b: number}[] => {
    let sortedArr: {a: number, b: number}[] = objArr.sort(function(a, b) {
        return +b - +a;
    }) 
    return sortedArr;
}
...
// const stringGroups = (array: string[]): {a: string[], b: string[]} => {}
...
const addContinent = (arr: {[key: string]: string}[], value: string): {[key: string]: string}[] => {
    let searchFirst = arr.find((obj) => obj.country=='Japan');
    searchFirst["continent"] = value;
    let searchSecond = arr.find((obj) => obj.country=='Thailand');
    searchSecond["continent"] = value;
    let searchThird = arr.find((obj) => obj.country=='Sweden');
    searchThird["continent"] = value;
    let searchFourth = arr.find((obj) => obj.country=='France');
    searchFourth["continent"] = value;
    return arr;
}
